...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">admin <span class="lite">yang baik</span></a>
      <!--logo end-->
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="task_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <p class="blue">Anda memiliki 6 surat yang menunggu keputusan</p>
              </li>
              <li>
                <a href="#">
                  <div class="task-info">
                    <div class="desc">Desain PSD </div>
                    <div class="percent">90%</div>
                  </div>
                  <div class="progress progress-striped">
                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%">
                      <span class="sr-only">90% Lengkap (Berhasil)</span>
                    </div>
                  </div>
                </a>
              </li>
                ...
                <a href="#">
                  ...
                  <div class="progress progress-striped">
                    <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%">
                      <span class="sr-only">30% Lengkap (Peringatan)</span>
                    </div>
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  <div class="task-info">
                    <div class="desc">Pemasaran Digital</div>
                    <div class="percent">80%</div>
                  </div>
                  <div class="progress progress-striped">
                    <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
                      <span class="sr-only">80% Lengkap</span>
                    </div>
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  <div class="task-info">
                    <div class="desc">Desain Logo</div>
                    <div class="percent">78%</div>
                  </div>
                  <div class="progress progress-striped">
                    <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100" style="width: 78%">
                      <span class="sr-only">78% Lengkap (Bahaya)</span>
                    </div>
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  <div class="task-info">
                    <div class="desc">Aplikasi Seluler</div>
                    <div class="percent">50%</div>
                  </div>
                  <div class="progress progress-striped active">
                    <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
                      <span class="sr-only">50% Lengkap</span>
                    </div>
                  </div>
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    ...
                                    <span class="subject">
                                    <span class="from">Adrian</span>
                                    <span class="time">5 Menit</span>
                                    </span>
                                    <span class="message">
                                     Hai, Apa rencana proyek selanjutnya? 
                                    </span>
                                </a>
              </li>
              <li>
                <a href="#">
                                    ...
                                    <span class="subject">
                                    <span class="from">Bastian</span>
                                    <span class="time">2 Jam</span>
                                    </span>
                                    <span class="message">
                                        Saya ingin membeli Template Admin ini.
                                    </span>
                                </a>
              </li>
              <li>
          ...
          <li id="alert_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              <div class="notify-arrow notify-arrow-blue"></div>
              <li>
                <p class="blue">Anda memiliki 4 notifikasi baru</p>
              </li>
              <li>
                <a href="#">
              ...
              <li>
                <a href="#">
                                    ...
                                    Ferdi.
                                    <span class="small italic pull-right">50 Menit</span>
                                </a>
              </li>
              <li>
                <a href="#">
                                    ...
                                    Proyek 3 Selesai.
                                    <span class="small italic pull-right">1 Jam</span>
                                </a>
              </li>
              <li>
                <a href="#">
                                    <span class="label label-success"><i class="icon_like"></i></span>
                                    Farid menghargai pekerjaan Anda.
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">Nizar Dwi Setyawan</span>
                            <b class="caret"></b>
                        </a>
            <ul class="dropdown-menu extended logout">
              <div class="log-arrow-up"></div>
              <li class="eborder-top">
                <a href="#"><i class="icon_profile"></i> Profil saya</a>
              </li>
              <li>
                <a href="#"><i class="icon_mail_alt"></i> Kotak Masuk Saya</a>
              </li>
              <li>
                <a href="#"><i class="icon_clock_alt"></i> Linimasa</a>
              </li>
              <li>
                <a href="#"><i class="icon_chat_alt"></i> Obrolan</a>
              </li>
              <li>
                <a href="login.html"><i class="icon_key_alt"></i> Keluar</a>
              </li>
              <li>
                <a href="documentation.html"><i class="icon_key_alt"></i> Dokumentasi</a>
              </li>
              <li>
                <a href="documentation.html"><i class="icon_key_alt"></i> Dokumentasi</a>
              </li>
