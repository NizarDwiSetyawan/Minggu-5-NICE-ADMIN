    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Membuat situs web yang membuat Anda tidak berhenti & menatap</h1>
          ...
          <div><a href="#about" class="btn-get-started scrollto">Memulai</a></div>
        </div>
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="text-center title">
          <h3>Apa yang telah kami capai sejauh ini</h3>
